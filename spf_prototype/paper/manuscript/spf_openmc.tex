...
Replacing the void interior and vacuum walls with a layered blanket---an ARC-class
box-torus with a $1$~mm tungsten first wall, $1$~cm of Fe-9Cr structural steel, a $1$~cm
...
geometry a reactor would actually build. For each of five quasi-symmetric QUASR
...
four of the five devices, perpendicular for one) but the achievable global flattening is
uniformly modest: peaking-optimal polarization lowers the peaking factor by only
$1$--$16\%$ across the set (for the most improved device, $1.78\to1.49$;
...
just-in-time compile. Finally, the conformal-wall predictor study is at present limited to
five devices, too few to establish a correlation between the steering benefit and any cheap
geometric descriptor; a larger equilibrium set is required to decide it.
