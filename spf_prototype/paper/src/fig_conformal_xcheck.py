...
ax.scatter(A_an, A_mc, s=10, facecolor="none", edgecolor="0.15", lw=0.5, label="A (Perpendicular)")
ax.scatter(B_an, B_mc, s=10, marker="s", facecolor="none", edgecolor="0.55", lw=0.5, label="B/C (Parallel)")
